    ...
    <section className="min-h-screen bg-[#F9FAFB] px-6 py-8">
      <div className="w-full">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[28px] font-semibold text-[#111827] mb-2">Job Satisfaction Assessment</h1>
            <p className="text-[14px] text-[#6B7280]">Rate your experience across different aspects of your role</p>
          </div>
        </div>

        {/* Rating Sliders Card */}
        <div className="bg-white rounded-lg p-6 border border-[#E5E7EB] shadow-sm mb-6" style={{ boxShadow: "0px 1px 3px rgba(0,0,0,0.05)" }}>
          <h3 className="text-[16px] font-semibold text-[#111827] mb-8">Employee Satisfaction Rating</h3>

          <div className="space-y-8">
            {ratingItems.map((item) => (
              <div key={item.key}>
                <div className="flex items-center justify-between mb-3">
                  <label className="text-[13px] font-medium text-[#111827]">{item.label}</label>
                ...
                <div className="flex justify-between mt-2">
                  <span className="text-[11px] text-[#9CA3AF]">1 – Very Poor</span>
                  <span className="text-[11px] text-[#9CA3AF]">5 – Excellent</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-lg p-6 border border-[#E5E7EB] shadow-sm" style={{ boxShadow: "0px 1px 3px rgba(0,0,0,0.05)" }}>
          <h3 className="text-[16px] font-semibold text-[#111827] mb-8">Exit Survey Questions</h3>

          {/* Question 1 */}
          <div className="mb-8">
            <label className="block text-[13px] font-semibold text-[#111827] mb-3">
              What is the primary reason for leaving? <span className="text-red-500">*</span>
            </label>
            <select
          ...
          <div className="mb-8">
            <label className="block text-[13px] font-semibold text-[#111827] mb-3">
              Would you recommend this company as a place to work? <span className="text-red-500">*</span>
            </label>
            <select
          ...
          <div className="mb-8">
            <label className="block text-[13px] font-semibold text-[#111827] mb-3">
              Would you consider returning to work for this company in the future? <span className="text-red-500">*</span>
            </label>
            <div className="space-y-2">
              {["Yes", "Maybe", "No"].map((option) => (
                <div key={option} className="flex items-center">
                  ...
                  />
                  <label htmlFor={`return-${option}`} className="ml-2 text-[13px] text-[#111827] cursor-pointer">
                    {option}
                  </label>
                </div>
              ))}
