            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-[12px] font-semibold text-[#6B7280] mb-1">Employee ID</p>
                    <p className="text-[14px] text-[#111827]">{exitData.employee.id}</p>
                  </div>
                  <div>
                    <p className="text-[12px] font-semibold text-[#6B7280] mb-1">Email Address</p>
                    <p className="text-[14px] text-[#111827]">{exitData.employee.email}</p>
                  </div>
                </div>
                <div className="mt-3">
                  <p className="text-[12px] font-semibold text-[#6B7280] mb-1">Joined Date</p>
                  <p className="text-[14px] text-[#111827]">{exitData.employee.joiningDate}</p>
                </div>
              </div>
            </div>
          </div>
