...
export default function ViewDetails() {
  ...
  const filteredTimeline = timelineEvents.filter((event) => {
    if (timelineFilter === "Completed Only")
      return event.status === "completed";
    if (timelineFilter === "In Progress Only")
    ...
    <section className="mx-auto max-w-6xl px-4 py-6">
      ...
      <div className="mt-6">
        ...
        >
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 text-white font-bold text-sm flex-shrink-0">
              SJ
            </div>
        ...
        <Tabs defaultValue="tasks">
          <div className="flex items-center justify-between border-b">
            <TabsList className="flex gap-0">
              <TabsTrigger
                value="tasks"
                className="px-4 py-2 text-sm font-medium border-b-2 border-transparent data-[state=active]:border-blue-600 data-[state=active]:text-blue-600 hover:text-foreground transition-colors"
              >
                Tasks ({tasks.length})
              </TabsTrigger>
              <TabsTrigger
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-xs text-[#6B7280]">
                    Track completion of required offboarding activities.
                  </p>
                </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span
                              className={`rounded-full px-1.5 py-0.5 text-[10px] font-medium ${priorityColors[task.priority]}`}
                            >
                              {task.priority}
                            </span>
                          </div>
          ...
          <TabsContent value="comments" className="mt-4">
            <div style={{ fontFamily: "Poppins, sans-serif" }}>
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-[#6B7280]">
                  Communication and updates related to this offboarding case.
                </p>
              </div>
              ...
              <div className="space-y-2 mb-6">
                {caseComments.map((comment) => (
                  <div
                    key={comment.id}
                    className="bg-white border border-[#E5E7EB] rounded-lg p-3 hover:shadow-sm transition-shadow group"
                  >
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-1.5">
                            <span className="font-bold text-[12px] text-[#111827]">
                              {comment.author}
                            </span>
            ...
            <div style={{ fontFamily: "Poppins, sans-serif" }}>
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-xs text-[#6B7280]">
                    Manage documents related to offboarding.
                  </p>
                </div>
                ...
                <div className="flex gap-2 items-center">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (isExportMode && selectedForExport.length > 0) {
                        alert(
                          `Downloading ${selectedForExport.length} file(s)...`,
                        );
                  ...
                  >
                    ...
                    {isExportMode
                      ? `Download (${selectedForExport.length})`
                      : "Export"}
                  </Button>

                  {isExportMode &&
                    selectedForExport.length < filteredDocuments.length && (
                      <Button
                        variant="outline"
              ...
              <div
                className="border border-[#E5E7EB] rounded-lg overflow-y-auto"
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    {documents.find((d) => d.id === deleteConfirm)?.name}"? This
                ...
                <div className="flex gap-3 justify-end">
                  ...
                  <AlertDialogAction
                    ...
                    onClick={() => {
                      setDocuments(
                        documents.filter((d) => d.id !== deleteConfirm),
                      );
          ...
          <TabsContent value="timeline" className="mt-4">
            <div style={{ fontFamily: "Poppins, sans-serif" }}>
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-[#6B7280]">
                  Chronological history of this offboarding case.
                </p>
              </div>
          ...
          <TabsContent value="access-security" className="mt-4">
            <div
              className="py-4 px-6 bg-white w-full"
              style={{ fontFamily: "Poppins, sans-serif", gap: "16px" }}
            >
              {/* Header Section */}
              <div className="mb-4">
                ...
                <p className="text-xs text-[#6B7280]">
                  Monitor and manage access across all systems.
                </p>
              </div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  const isRevoked =
                    systemAccess[system.key as keyof typeof systemAccess];
                  return (
                    <div
                      key={system.key}
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`text-[12px] ${isRevoked ? "text-red-600 font-medium" : "text-[#6B7280]"}`}
                        >
