        ...
        <Tabs defaultValue="tasks">
          ...
          <TabsContent value="access-security" className="mt-4">
            <div>
              {/* Header Section */}
              <div className="mb-6">
                <h3 className="text-lg font-bold text-[#111827]">Access & Security</h3>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {[
                    { item: "Email Access", status: "Pending", color: "bg-yellow-100 text-yellow-700" },
                    { item: "VPN Access", status: "Revoked", color: "bg-red-100 text-red-700" },
                    { item: "Network Access", status: "Active", color: "bg-blue-100 text-blue-700" },
                    { item: "Cloud Services", status: "Active", color: "bg-blue-100 text-blue-700" },
                  ].map((access, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 border border-[#E5E7EB] rounded-lg bg-white hover:shadow-sm transition-shadow">
                      <div>
                        <span className="font-medium text-[#111827]">{access.item}</span>
                      </div>
                      <span className={`text-xs font-medium px-3 py-1 rounded-full ${access.color}`}>
                        {access.status}
                      </span>
                    </div>
                  ))}
              ...
              <div className="mb-6">
                <h4 className="font-semibold text-[16px] text-[#111827] mb-4">Devices & Equipment</h4>
                <div className="space-y-3">
                  {[
                    { item: "Laptop (MacBook Pro)", status: "Returned", color: "bg-green-100 text-green-700" },
                    { item: "Monitor", status: "Pending Return", color: "bg-yellow-100 text-yellow-700" },
                    { item: "Access Card", status: "Collected", color: "bg-green-100 text-green-700" },
                    { item: "Mobile Device", status: "Active", color: "bg-blue-100 text-blue-700" },
                  ].map((device, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 border border-[#E5E7EB] rounded-lg bg-white hover:shadow-sm transition-shadow">
                      <div>
                        <span className="font-medium text-[#111827]">{device.item}</span>
                      </div>
                      <span className={`text-xs font-medium px-3 py-1 rounded-full ${device.color}`}>
                        {device.status}
                      </span>
                    </div>
                  ))}
              ...
              <div className="mb-6">
                <h4 className="font-semibold text-[16px] text-[#111827] mb-4">Security & Compliance</h4>
                <div className="space-y-3">
                  {[
                    { item: "Background Check Status", status: "Completed", color: "bg-green-100 text-green-700" },
                    { item: "NDA Acknowledgment", status: "Signed", color: "bg-green-100 text-green-700" },
                    { item: "Security Training", status: "Completed", color: "bg-green-100 text-green-700" },
                    { item: "Exit Interview", status: "Scheduled", color: "bg-blue-100 text-blue-700" },
                  ].map((clearance, idx) => (
                    <div key={idx} className="flex items-center justify-between p-3 border border-[#E5E7EB] rounded-lg bg-white hover:shadow-sm transition-shadow">
                      <div>
                        <span className="font-medium text-[#111827]">{clearance.item}</span>
                      </div>
                      <span className={`text-xs font-medium px-3 py-1 rounded-full ${clearance.color}`}>
                        {clearance.status}
                      </span>
                    </div>
                  ))}
              ...
              <div className="border border-[#E5E7EB] rounded-lg p-4 bg-[#F9FAFB]">
                <h4 className="font-semibold text-[14px] text-[#111827] mb-2">Additional Notes</h4>
                <p className="text-sm text-[#6B7280]">All access revocation scheduled for January 16, 2024. Ensure final data backup is completed before email account closure.</p>
              </div>
            </div>
          </TabsContent>
        </Tabs>
